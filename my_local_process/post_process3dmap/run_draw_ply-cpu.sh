...
map_path=../../outputs/replica_multiroom/ngp_3dmap-insid-warmup10000.h5
map_path=../../outputs/replica_multiroom/ngp_3dmap-insid-semdistortion_nowarmup.h5
map_path=../../outputs/replica_multiroom_stable_depth/ngp_3dmap.h5
# single room
