...
ckpt_path=outputs/replica_multiroom_stable_noisy/checkpoints-with_grad/ngp_ep0005.pth
# ckpt_path=outputs/replica_multiroom_stable_noisy/checkpoints-block_grad/ngp_ep0005.pth
# ckpt_path=outputs/replica_multiroom_stable/checkpoints/ngp_ep0005.pth
...
--sem_mode label_id --warmup_iter 100000 --ckpt $ckpt_path \
